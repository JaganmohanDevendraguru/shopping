<nav class="col-md-2 d-none d-md-block bg-light sidebar">
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a class="nav-link" href="${context}/view/categories"> <span
								data-feather="file"></span> Categories
						</a></li>
						<li class="nav-item"><a class="nav-link" href="${context}/view/products"> <span
								data-feather="file"></span> Products
						</a></li>
						<li class="nav-item"><a class="nav-link" href="${context}/view/employees"> <span
								data-feather="shopping-cart"></span> Employees
						</a></li>
						<li class="nav-item"><a class="nav-link" href="${context}/view/customers"> <span
								data-feather="users"></span> Customers
						</a></li>
						<li class="nav-item"><a class="nav-link" href="${context}/view/suppliers"> <span
